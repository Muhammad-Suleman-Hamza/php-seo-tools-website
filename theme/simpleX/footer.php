...
<footer class="footer" style="background: #232C3B !important;border:0 !important;
							  color: white !important;">
 		<!-- Widget Area -->
		<div class="b-widgets" style="background: #232C3B !important;color: white !important;">
			<div class="container layout">
				<div class="row">
					<!-- About Us -->
					<div class="row-item col-md-6">
						<h3 class="footer-title" style="color: white !important;"><?php echo $lang['RF107']; ?></h3>
						<div class="b-twitter m-footer" style="">
					...
					<div class="row-item col-md-3">
						<h3 class="footer-title" style="color: white !important;"><?php echo $lang['314']; ?></h3>
						<ul class="b-list just-links m-dark"style="color: white !important;">
					...
					<!-- Links -->
					<div class="row-item col-md-3">
						<h3 class="footer-title" style="color: white !important;"><?php echo $lang['316']; ?></h3>
       ...
       <div class="container">
        <div class="row">
            ...
            <p>Copyright © 2020 ApkModWorld All rights reserved. Made with 🖤 by Tech Box.</p>
            </div>
        </div>
       </div>
